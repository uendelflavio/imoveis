	...
	return (
		<AppSettings.Consumer>
			{({toggleAppSidebarMinify, toggleAppSidebarMobile, appSidebarTransparent}) => (
				<React.Fragment>
					<div id="sidebar" className={'app-sidebar ' + (context.appSidebarTransparent ? 'app-sidebar-transparent' : '')}>
						<PerfectScrollbar className="app-sidebar-content h-100" options={{suppressScrollX: true}}>
							...
							<div className="menu">
								<div className="menu-item d-flex">
									<Link to="/" className="app-sidebar-minify-btn ms-auto" onClick={context.toggleAppSidebarMinify}>
					...
					<div className="app-sidebar-mobile-backdrop"><Link to="/" onClick={context.toggleAppSidebarMobile} className="stretched-link"></Link></div>
				</React.Fragment>
			)}
		</AppSettings.Consumer>
	)
