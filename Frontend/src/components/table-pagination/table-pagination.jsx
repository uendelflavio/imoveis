      ...
      {props.page.length > 0 ?
        <div className="d-md-flex align-items-center"    >
          <div sytle={{ fontFamily: 'Roboto' }} className="me-md-auto text-md-left text-center mb-2 mb-md-0 fw-bolder" >
           { props.page.length === 1 ?            
              `Mostrando ${props.page[0].values.id.toString().padStart(3, "0")} até ${props.page[0].values.id.toString().padStart(3, "0")} com o total de ${props.page.length} registro(s)`                      
            :                          
              `Mostrando ${props.page[0].values.id.toString().padStart(3, "0")} até ${props.page[(props.page.length - 1)].values.id.toString().padStart(3, "0")} com o total de ${props.page.length} registro(s)`           
           }
          </div>
          <Button
