          ...
          {context.appSidebarTwo && (
            <React.Fragment>
                  ...
                  <div className="p-20px text-white">
                    ...
                    >
                      {state.collapse.map((value, i) => (
                        ...
                        >
                          <CardHeader
                            className={"card-header bg-gray-900 text-white pointer-cursor border-0 d-flex align-items-center rounded-0 " +
                              (!value.collapse ? "collapsed " : "")}
                            onClick={() => toggleCollapse(value.id)}
                          >
                            <i className="fa fa-circle text-teal fs-6px me-2">
                            </i>{" "}
              ...
              <div className="app-sidebar-mobile-backdrop app-sidebar-end">
                <Link
                  to="/"
                  onClick={context.toggleAppSidebarEndMobile}
