...
const TopMenuNavList = props => {
  ...
  var caret =
    props.data.children && !props.data.badge && <div className="menu-caret" />;
  var label =
    props.data.label &&
    <span className="menu-label ms-5px">
      {props.data.label}
    </span>;
  var badge =
    props.data.badge &&
  ...
  var highlight =
    props.data.highlight && <i className="fa fa-paper-plane text-theme" />;
  var title =
    props.data.title &&
        ...
        children={({ match }) =>
          <div
            ...
            {props.data.children
              ...
              : <Link className="menu-link" to={props.data.path}>
                  {img} {icon} {title} {caret} {badge}
                </Link>}
            {props.data.children &&
              <div
                className={"menu-submenu " + (props.active ? "d-block" : "")}>
                {props.data.children &&
