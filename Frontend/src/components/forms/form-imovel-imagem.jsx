...
const FormImovelImagem = (props) => {
  ...
  const validationSchema = Yup.object({      
    image: Yup
      .mixed()
      .nullable()
      .required('O arquivo e obrigatorio')      
      .test(
        'type',
  ...
  return (
    <Fragment>
      ...
      <Modal centered toggle={toggle} isOpen={modalOpen} autoFocus={false} width="200px">
        <Panel className="mb-0" >
          ...
          <PanelBody>                                                    
            <Formik               
              ...
              >
              <Form>                                
                <FieldInput label="Descrição" name="descricao" focus={true}/>
                <FieldInputFile  name="image" />                                                 
