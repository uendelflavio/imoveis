...
import SidebarRight from "components/ui/sidebar-right/sidebar-right.jsx";
import TopMenu from "components/ui/top-menu/top-menu.jsx";
import Content from "components/ui/content/content.jsx";
import FloatSubMenu from "components/ui/float-sub-menu/float-sub-menu.jsx";
import PanelTheme from "components/ui/panel-theme/panel-theme.jsx";
...
const AppHooks = (props) => {
  ...
  const handleAppSidebarFloatSubMenuClick = () => {
    if (state.appSidebarMinify) {
      ...
      const targetHeight = document.getElementById("app-sidebar-float-submenu")
        .offsetHeight;
